...
public class TC2 extends Base2{
	  ////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  @Test(priority=1,enabled=true,description="Not Selecting Adult1 title")
	  ...
	  ///////////////////////////////////////////////////////////////////////////////////////////
	  @Test(priority=2,enabled=true,description="Adult1 first name is required")
	...
	///////////////////	///////////////////////////////////////////////////////////   
	  ...
	  @Test(priority=3,enabled=true,description="Adult1 last name is required")
		  ...
		  driver.get("https://www.easemytrip.com/");
			...
			driver.findElement(By.xpath("//input[@id='txtCPhone']")).sendKeys("7777777777");
			 ...
			 Thread.sleep(1000);
			  driver.findElement(By.xpath("//span[@id='spnTransaction']")).click();
			  String error= driver.findElement(By.id("spanErrorAdult0")).getText();
			 Assert.assertEquals(true,error.contains("Adult 1 Last Name "));
	  }
	  @Test(priority=3,enabled=true,description="Entering wrong debit card number")
